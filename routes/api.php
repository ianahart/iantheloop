...
Route::get('/auth/messages/{recipientId}/show', [ConversatorController::class, 'showChatMessages'])->middleware('auth:api');
Route::post('/auth/messages', [ConversatorController::class, 'store'])->middleware('auth:api');
Route::get('/auth/conversator/{userId}/show', [ConversatorController::class, 'show'])->middleware('auth:api');
