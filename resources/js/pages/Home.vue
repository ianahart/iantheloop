    ...
    <div class="home__container">
        ...
        <section class="home_main">
            <div class="home_main_row">
                <div class="home_tagline_container">
                    ...
                    <p>
                        Prosciutto pancetta short loin pork belly venison pork
                        chop sirloin t-bone. Pastrami salami capicola chicken
                        pork jowl tail turkey meatball filet mignon.
                    </p>
        ...
        <section class="home_description">
            <div class="home_description_content">
                <h2>
                    A place where location does not matter, tay in the loop with
                    new and old friends
                </h2>
                <p>
        ...
        <section class="home_difference_list">
            ...
            <div class="home_difference_list_content">
                ...
                <div class="home_difference_list_content_text">
                    <h2>
                        An alternative to bloated social apps, only essential
                        features included
                    </h2>
            ...
            <div class="home_service_offers_container">
                <div class="home_service_offers_text">
                    ...
                    <p>
                        ...
                        e-services. Seamlessly empower fully researched growth
                        strategies and interoperable internal or "organic"
                        sources.
                    </p>
                    <ul class="home_list_default">
                        <li>Dramatically maintain clicks-and-mortar</li>
                        <li>
                            Seamlessly visualize quality intellectual capital
                        </li>
                        <li>
        ...
        <section class="home_interests">
            ...
            <div class="home_interests_text">
                ...
                <p>
                    Robotic process automation share purchase agreement spam
                    score marketing automation platform lead segmentation share
                    purchase agreement pro forma invoice organic search traffic
