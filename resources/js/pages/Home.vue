<template>
    <div class="home__container">
                ...
                <div class="home_main_row">
                    <div class="home_tagline_container">
                        ...
                        <div class="home_tagline_actions">
                            <router-link class="home_action_btn" :to="{name: 'CreateAccount'}">Signup</router-link>
                            <a class="home_action_btn" href="mailto:looped@example.com?subject=Basic Information:">Contact</a>
                        </div>
                    </div>
         ...
         <section class="home_description">
            ...
            <h2>A place where location does not matter, tay in the loop with new and old friends</h2>
        ...
        <section class="home_difference_list">
          ...
          <div class="home_difference_list_content">
            <img class="" :src="require('../../assets/home_offers.svg').default" alt="a person looking at a list of there friends who are online" />
            <div class="home_difference_list_content_text">
               <h2>An alternative to bloated social apps, only essential features included</h2>
               <ul class="home_list_default">
                   ...
                   <li>Holistically pontificate installed base portals after maintainable products.</li>
               </ul>
                   <router-link class="home_action_btn" :to="{name: 'AboutLooped'}">Learn More</router-link>
            </div>
          </div>
        </section>
        ...
        <section class="home_interests">
           <img class="" :src="require('../../assets/home_interests.svg').default" alt="users connected to the same page" />
           <img v-if="!thresholdPassed" class="decorative_star_2 decorative_star" :src="require('../../assets/decoration-star.svg').default" alt="decorative star images" />
           <div class="home_interests_text">
               <h2>Find common interests</h2>
               <p>Robotic process automation share purchase agreement spam score marketing automation platform lead segmentation share purchase agreement pro forma invoice organic search traffic single sign on feature.</p>
           </div>
        </section>
        <section class="home_reviews">
            <span class="review_quote_icon">&#8222;</span>
         <div v-if="testimonials && testimonials.length" class="home_reviews_container">
            <div class="home_reviews_swiper">
              <svg @click="swipePrev" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 reviews_swiper_left" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div class="home_reviews_list">
                  <transition name="swiper" mode="out-in" appear>
                     <div
                      ...
                      <h4>- {{ testimonials[current].full_name.split(' ').map(word => word.toUpperCase().slice(0, 1) + word.toLowerCase().slice(1)).join(' ') }}</h4>
                   </div>
                 </transition>
              </div>
              <svg @click="swipeNext" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 reviews_swiper_right" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default {
    ...
    beforeDestroy() {
        ...
        winow.clearInterval(this.swiperID);
