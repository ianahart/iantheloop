  ...
  <transition name="modal" appear>
    <div ref="modal" class="profile_stats_following__modal">
      ...
      <div class="follow__modal_actions">
        ...
        <div
          @click="unFollow(baseProfileData.user_id)"
          class="unfollow__action"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
...
export default {
  ...
  computed: {
    ...mapState("profile", ["isModalOpen", "baseProfileData"]),
  },

  methods: {
    ...mapActions("profile", ["UNFOLLOW"]),
    ...
    closeModal(e) {
      ...
      if (
        e.target !== modalRef &&
        e.target.className !== "profile_stats_following_btn"
      ) {
